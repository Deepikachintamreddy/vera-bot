...
BOT_URL = "https://DeepikaChintamreddy-vera-bot.hf.space"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = "groq"

# Your API key (paste your key here)
LLM_API_KEY = ""  # <-- PUT YOUR API KEY HERE (will be loaded from environment if empty)

# Model to use (leave empty for default, or specify like "gpt-4o", "claude-3-5-sonnet-20241022", etc.)
LLM_MODEL = "mixtral-8x7b-32768"  # Current available GROQ model
...
class GroqProvider(LLMProvider):
    def __init__(self, api_key: str, model: str = ""):
        self.api_key = api_key
        self.model = model or "mixtral-8x7b-32768"  # Updated from decommissioned llama-3.1-70b
